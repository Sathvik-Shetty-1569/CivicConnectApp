...
public class ShowCompleteReports extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ProblemManagement.FetchProblemsByStatus("Resolved", new ProblemManagement.GetAllProblems() {
            @Override
            public void GetFetchData(ArrayList<ProblemModel> ProblemDataList) {
                if (ProblemDataList.size() == 0) {
                    ...
                    CompleteReportsRecyclerView.setVisibility(View.GONE);
                } else {
                    CompleteReportsRecyclerView.setVisibility(View.VISIBLE);
                    progressBar.setVisibility(View.GONE);
                    noDataFoundText.setVisibility(View.GONE);
                    problemDataList = ProblemDataList;
                    CompleteReportsRecyclerView.setAdapter(new ShowProblemRecyclerAdapterAuthority(ShowCompleteReports.this, problemDataList));
                }
            }
        });
    }
